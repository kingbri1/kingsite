      ...
      <article className="text-whitesmoke">
        ...
        <div className="flex flex-col items-center filebridge-privacy">
          ...
          <div className="inline-flex flex-col bg-lightbg prose font-paragraph leading-spread px-6 lg:px-10 py-6 md:max-w-3xl xl:max-w-4xl rounded-xl">
            ...
            <h2>In short</h2>
            <p>Asobi and the developer (kingbri) do not collect your data. Period.</p>
            <h2>Why?</h2>
            <p>
              Asobi is a browser which does not collect any data from you. All of your data is your
              own and the developer (kingbri) or any other parties cannot see any data you store.
              <br />
              <br />
              Due to the app being free and open source (FOSS), you can view&nbsp;
              <a href="https://github.com/kingbri1/Asobi">the code</a>
